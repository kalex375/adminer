...
if ($_GET["file"] == "favicon.ico") {
    ...
    echo lzw_decompress(compile_file('../adminer/static/default.css;../externals/jush/jush.css;../externals/CodeMirror/lib/codemirror.css;../externals/CodeMirror/theme/darcula.css', 'minify_css'));
...
} elseif ($_GET["file"] == "codemirror.js") {
    header("Content-Type: text/javascript; charset=utf-8");
    echo compile_file('../externals/CodeMirror/lib/codemirror.js');
} elseif ($_GET["file"] == "sql.js") {
    header("Content-Type: text/javascript; charset=utf-8");
    echo compile_file('../externals/CodeMirror/mode/sql/sql.js');
} else {
